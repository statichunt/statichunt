...
// // get blog data
// const getblog = fs.readdirSync(path.join(`content/blog`));
// const sanitizeblog = getblog.filter((resource) =>
//   resource.includes(".md")
// );
// const filterblog = sanitizeblog.filter((resource) =>
//   resource.match(/^(?!_)/)
// );
// const blog = filterblog.map((filename) => {
//   const slug = filename.replace(".md", "");
//   const postData = fs.readFileSync(
