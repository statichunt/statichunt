...
export const getRegularPage = async (slug) => {
  ...
  const publishedThemes = getSinglePages("content/themes");
  const publishedResources = getSinglePages("content/resources");
...
export const getRegularPageSlug = () => {
  ...
  const ssgPage = getSinglePagesSlug(`content/ssg`);
  const cssPage = getSinglePagesSlug(`content/css`);
  const toolPage = getSinglePagesSlug(`content/tool`);

  const allSlug = [...regularPage, ...toolPage, ...ssgPage, ...cssPage];
