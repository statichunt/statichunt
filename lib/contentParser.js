...
export const getSinglePage = (folder) => {
  ...
  const singlePages = filterSingleFiles.map((filename) => {
    ...
    // const url = frontmatter.examples_url
    //   ? frontmatter.examples_url.replace("/", "") + "a"
    //   : frontmatter.url
...
export const getRegularPageSlug = () => {
  ...
  // const examplesPage = getSinglePage("content/examples");
  // const examplesFiltering = examplesPage.filter((page) => !page.frontmatter.page_draft);
  const examplesSlugs = ssgFiltering
